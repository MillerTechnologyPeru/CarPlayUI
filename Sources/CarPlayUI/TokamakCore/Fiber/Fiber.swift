  ...
  final class Fiber {
    ...
    init<V: View>(
      ...
      self.preferenceParent = preferenceParent
        typeInfo = CarPlayUI.typeInfo(of: V.self)
    ...
    private func bindProperties(
      ...
      for property in typeInfo.properties where property.type is DynamicProperty.Type {
        ...
        bindProperties(to: &value, CarPlayUI.typeInfo(of: property.type), environment)
    ...
    private func updateDynamicProperties(
      ...
      for property in typeInfo.properties where property.type is DynamicProperty.Type {
        ...
        updateDynamicProperties(of: &value, CarPlayUI.typeInfo(of: property.type))
        // swiftlint:disable:next force_cast
    ...
    init<A: App>(
      ...
      element = rootElement
      typeInfo = CarPlayUI.typeInfo(of: A.self)
    ...
    init<S: Scene>(
      ...
      self.element = element
      self.preferenceParent = preferenceParent
      typeInfo = CarPlayUI.typeInfo(of: S.self)
